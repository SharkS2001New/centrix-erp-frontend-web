...
export const ACCOUNTING_GUIDE_PARTS = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Import CSV/text only (not Excel): headers date, description, reference, amount — or debit/credit columns.",
      "Example row: 2026-06-01,Deposit,DEP-1,1500 — deposits positive, withdrawals negative.",
      "Match bank lines to book transactions (or use suggested matches: amount within 0.02, dates within ~7 days).",
      "Exclude lines that are not part of this period. Unmatch if you made a mistake (while still in progress).",
      "Add adjustment — posts a small balancing journal when difference is immaterial.",
      "Finish when |difference| < 0.02 — matched items are cleared from future reconciliations.",
      "Not the same as M-Pesa / Equity / Centrix Payments reconciliation hubs.",
    ],
