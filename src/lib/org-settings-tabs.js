...
import { hasApprovalsSettingsTab } from "@/lib/approvals-settings";
import {
  isPlatformAiEnabled,
...
export const ORG_SETTINGS_TAB_MODULES = {
  ...
  approvals: ["sales", "inventory", "customers_suppliers", "hr_payroll", "accounting", "admin"],
  inventory: ["inventory"],
...
export function isOrgSettingsTabVisible(tabId, capabilities, { platformManaged = false, tenantSelfService = false } = {}) {
  switch (tabId) {
    ...
    case "approvals":
      return hasApprovalsSettingsTab(capabilities);
