...
export const ADMIN_SETTINGS_CATALOG = [
  ...
  },
  {
    ...
    description: "Paybill and buy goods till shortcodes with optional per-account Daraja keys",
    keywords: ["paybill", "shortcode", "till number", "store number", "multi paybill", "saved accounts"],
    group: "Finance",
    path: "Admin → Finance → Saved M-Pesa accounts",
    href: "/admin/mpesa-settings?section=paybills",
    navHref: "/admin/mpesa-settings?section=paybills",
  },
  {
  ...
  },
  {
    ...
    description: "Hospitality front desk and food & drink preferences",
    keywords: ["hotel", "hospitality", "fnb", "food", "drink", "front desk", "rooms"],
    group: "Organization",
    path: "Admin → Hotel food & drink settings",
