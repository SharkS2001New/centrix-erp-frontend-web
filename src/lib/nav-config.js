  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: "Price history",
        module: null,
        permission: P.pricing_tax.price_history.view,
      },
      {
        href: "/reports/kra-invoices",
        label: "KRA invoices",
        module: null,
        permission: P.pricing_tax.kra_invoices.view,
    ...
    items: [
      {
        ...
        module: "sales.backend",
        permission: P.shop_debtors.unpaid.view,
      ...
      },
      {
        ...
        module: "sales.backend",
        permission: P.shop_debtors.partial.view,
        requireShopDebtors: true,
      },
      {
        ...
        label: "Paid Debtors",
        module: "sales.backend",
        permission: P.shop_debtors.paid.view,
        requireShopDebtors: true,
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        module: "hr_payroll",
        permission: P.hr.attendance_history.view,
      },
      {
        href: "/hr/missed-punches",
        label: "Missed punches",
        module: "hr_payroll",
        permission: P.hr.missed_punches.view,
      },
      {
        href: "/hr/duplicate-punches",
        label: "Duplicate punches",
        module: "hr_payroll",
        permission: P.hr.duplicate_punches.view,
      },
      {
        href: "/hr/absents",
        label: "Absents",
        module: "hr_payroll",
        permission: P.hr.absents.view,
      },
      {
        href: "/hr/lateness",
        label: "Lateness",
        module: "hr_payroll",
        permission: P.hr.lateness.view,
      },
      {
        href: "/hr/leave",
        label: "Leave",
      ...
      },
      {
        ...
        module: "hr_payroll",
        permission: P.hr.pending_overtime.view,
      },
      {
        href: "/hr/overtime",
        label: "Overtime",
