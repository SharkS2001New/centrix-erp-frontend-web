...
<style id="centrix-print-baseline">
   ...
   * (e.g. payroll sheet / wide reports). Page size comes from the document itself.
   * Prefer explicit mm sizes (210mm 297mm / 297mm 210mm) over the landscape
   * keyword — some engines rotate content when both are applied.
   */
  @page {
    margin: 0 !important;
  }
