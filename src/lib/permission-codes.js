...
export const P = {
  ...
  pricing_tax: {
    vat_rates: {
      view: "pricing_tax.vat_rates.view",
      create: "pricing_tax.vat_rates.create",
      edit: "pricing_tax.vat_rates.edit",
      delete: "pricing_tax.vat_rates.delete",
    },
    price_list: { view: "pricing_tax.price_list.view" },
...
export function reportPermissionCode(reportKey) {
  const map = {
    ...
    "price-list": P.pricing_tax.price_list.view,
    ...
    "lateness-list": P.hr.lateness.view,
    ...
    "kra-invoices": P.pricing_tax.kra_invoices.view,
