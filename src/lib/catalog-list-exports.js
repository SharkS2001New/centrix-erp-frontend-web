...
export const ATTENDANCE_EXPORT_COLUMNS = [
  ...
  { key: "late_minutes", label: "Late clock-in (min)", align: "right" },
  { key: "lunch_late_minutes", label: "Late from lunch (min)", align: "right" },
  { key: "total_late_minutes", label: "Overall late (min)", align: "right" },
...
export const STOCK_ON_HAND_EXPORT_COLUMNS = [
  ...
  { key: "available_shop_quantity", label: "Shop available", align: "right" },
  { key: "available_store_quantity", label: "Store available", align: "right" },
  { key: "shop_quantity", label: "Shop on hand", align: "right" },
  { key: "store_quantity", label: "Store on hand", align: "right" },
  { key: "total_base_units", label: "Total on hand", align: "right" },
...
export const DISPATCH_TRIP_EXPORT_COLUMNS = [
  ...
  { key: "financial_summary.net_profit", label: "Net profit", align: "right" },
