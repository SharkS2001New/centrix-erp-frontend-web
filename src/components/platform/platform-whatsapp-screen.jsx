...
/>
  ...
  disabled={!context}
  options={[{ value: "", label: "— Unknown / unregistered phone —" }, { value: c.customer_num, label: {c.customer_name} (#{c.customer_num}
...
/>
  ...
  options={[{ value: "", label: "— Select org user —" }, { value: u.id, label: {u.full_name || u.username}
