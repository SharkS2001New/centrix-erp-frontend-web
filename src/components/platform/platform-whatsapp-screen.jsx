...
export function PlatformWhatsappScreen() {
          ...
          <div className="mt-5 space-y-4">
            <Field label="Webhook URL">
              <div className="flex gap-2">
                ...
                <PrimaryButton type="button" showIcon={false} onClick={() => void copyWebhookUrl()}>
                  Copy
                </PrimaryButton>
              </div>
            ...
            <Field label="Webhook verify token">
              <input
                ...
                placeholder={form.webhook_verify_token_set ? form.webhook_verify_token_hint || "••••••••" : "Choose a secret token"}
                autoComplete="off"
              />
