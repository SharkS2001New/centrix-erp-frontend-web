              ...
              {form.email_enabled ? (
                <>
                  ...
                  <div className="space-y-4 border-t border-slate-200 pt-6">
                    <div>
                      <p className="text-sm font-medium text-slate-800">Internal approval alerts</p>
                      <p className="mt-1 text-xs text-slate-500">
                        Email approvers and requesters when in-app approval notifications are created or resolved.
                        Requires email enabled above and a valid recipient email on each user account.
                      </p>
                    </div>
                    <Toggle
                      ...
                      <div className="grid gap-4 lg:grid-cols-2">
                        <Field label="Approval request email subject">
                          <input
                            ...
                            disabled={!form.email_enabled}
                            onChange={(e) =>
                              setForm((f) => ({ ...f, approval_request_email_subject: e.target.value }))
                            }
                          />
                        </Field>
                        <Field label="Approval request email body">
                          <textarea
                            ...
                            disabled={!form.email_enabled}
                            onChange={(e) =>
                              setForm((f) => ({ ...f, approval_request_email_template: e.target.value }))
                            }
                          />
                        </Field>
                      ...
                      <div className="grid gap-4 lg:grid-cols-2">
                        <Field label="Outcome email subject">
                          <input
                            ...
                            disabled={!form.email_enabled}
                            onChange={(e) =>
                              setForm((f) => ({ ...f, approval_outcome_email_subject: e.target.value }))
                            }
                          />
                        </Field>
                        <Field label="Outcome email body">
                          <textarea
                            ...
                            disabled={!form.email_enabled}
                            onChange={(e) =>
                              setForm((f) => ({ ...f, approval_outcome_email_template: e.target.value }))
                            }
                          />
                        </Field>
                        <p className="lg:col-span-2 text-xs text-slate-500">
