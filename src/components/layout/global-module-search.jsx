...
export function GlobalModuleSearch() {
  ...
  return (
    <div ref={containerRef} className="flex min-w-0 flex-1 items-center gap-1.5 sm:max-w-xl md:max-w-2xl">
      <div className="app-topbar-search relative hidden min-w-0 flex-1 sm:block">
