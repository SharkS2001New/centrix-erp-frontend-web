  ...
  return (
    ...
    >
      <div className="space-y-8">
        ...
        <section
          id="check-receipts"
          className="rounded-xl border border-[var(--theme-border)] bg-[var(--theme-surface)] px-4 py-4"
        >
          <h2 className="theme-heading text-base font-semibold">Check receipts</h2>
